...
export default function SofteningDayScreen() {
      ...
      >
        ...
        >
          ...
          <View style={styles.meta}>
            <Text style={styles.dayLabel}>Softening · Day {challenge.day}</Text>
            {isCompleted && (
...
const styles = StyleSheet.create({
  ...
  exerciseCard: { borderColor: COLORS.primary + '33' },
  exerciseHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  exerciseLabel: { color: COLORS.primary },
  cardText: {
    color: COLORS.text,
    fontSize: 16,
    lineHeight: 26,
  ...
  saveBtnTextDone: { color: COLORS.primary },
  reminderWrapper: { marginTop: 4 },
});
